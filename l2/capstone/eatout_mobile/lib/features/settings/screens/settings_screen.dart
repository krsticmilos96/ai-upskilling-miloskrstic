    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          ...['Create and manage your restaurant menu', 'Set prices and availability', 'Analytics and insights', 'Priority support'].map(
            (feature) => Padding(
    ...
    return _buildSection(
      ...
      [
        _buildSettingsItem(
          ...
          onTap: () {
            // TODO: Navigate to restaurant management or show upgrade prompt
          },
          trailing: Container(
